...
function CompanyDetails() {
  ...
  const { companyDetails,companyId ,token,companyLogo} = useSelector((state) => {
    return {
  ...
  return (
    ...
    <CompaniesNavbar/>
      ...
      <button id="But" onClick={() => {handleUpdateClick(companyId) }}> <a href="#P3">Edit My Information !</a></button> <button style={{marginLeft:"50px"}}
            onClick={() => {
